...
class GameApi:
    ...
    def get_game_search(
        ...
        filter_type_enum: Annotated[Optional[List[StrictStr]], Field(description="multi-filter results with the english item type name, including \"mount\" and \"set\" from filter[type]. Add with \"wood\" or \"+wood\" and exclude with \"-wood\".")] = None,
        ...
        :param filter_type_enum: multi-filter results with the english item type name, including \"mount\" and \"set\" from filter[type]. Add with \"wood\" or \"+wood\" and exclude with \"-wood\".
