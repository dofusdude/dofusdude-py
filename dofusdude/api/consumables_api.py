...
class ConsumablesApi:
    ...
    def _get_all_items_consumables_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/consumables/all',
    ...
    def _get_items_consumables_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/consumables',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_items_consumables_search_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/consumables/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_items_consumables_single_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/consumables/{ankama_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
