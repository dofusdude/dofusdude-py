...
class SetsApi:
    ...
    def get_all_sets_list(
        ...
        filter_is_cosmetic: Annotated[Optional[StrictBool], Field(description="filter sets based on if they only got cosmetic items in it. If true, the item ids are for the cosmetic endpoints instead of equipment.")] = None,
        ...
        :param filter_is_cosmetic: filter sets based on if they only got cosmetic items in it. If true, the item ids are for the cosmetic endpoints instead of equipment.
        :type filter_is_cosmetic: bool
        ...
        _param = self._get_all_sets_list_serialize(
            ...
            filter_is_cosmetic=filter_is_cosmetic,
    ...
    def _get_all_sets_list_serialize(
        ...
        if filter_is_cosmetic is not None:
            
            _query_params.append(('filter[is_cosmetic]', filter_is_cosmetic))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/sets/all',
    ...
    def _get_sets_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/sets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_sets_search_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/sets/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_sets_single_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/sets/{ankama_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
