...
class ResourcesApi:
    ...
    def get_all_items_resources_list(
        ...
        _param = self._get_all_items_resources_list_serialize(
            language=language,
            game=game,
    ...
    def _get_all_items_resources_list_serialize(
        self,
        language,
        game,
        sort_level,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/resources/all',
    ...
    def get_items_resource_search(
        ...
        _param = self._get_items_resource_search_serialize(
            language=language,
            game=game,
            query=query,
            filter_min_level=filter_min_level,
    ...
    def _get_items_resource_search_serialize(
        self,
        language,
        game,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/resources/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_items_resources_list(
        ...
        _param = self._get_items_resources_list_serialize(
            language=language,
            game=game,
            sort_level=sort_level,
            filter_min_level=filter_min_level,
    ...
    def _get_items_resources_list_serialize(
        self,
        language,
        game,
        sort_level,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/resources',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_items_resources_single(
        ...
        _param = self._get_items_resources_single_serialize(
            language=language,
            ankama_id=ankama_id,
            game=game,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_items_resources_single_with_http_info(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        ankama_id: Annotated[StrictInt, Field(description="identifier")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
    ...
    @validate_call
    def get_items_resources_single_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        ankama_id: Annotated[StrictInt, Field(description="identifier")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
    ...
    def _get_items_resources_single_serialize(
        self,
        language,
        ankama_id,
        game,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/resources/{ankama_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
