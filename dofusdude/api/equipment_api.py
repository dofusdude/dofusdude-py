...
class EquipmentApi:
    ...
    @validate_call
    def get_all_items_equipment_list(
        self,
        ...
        filter_max_level: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="only results which level is equal or below this value")] = None,
        ...
        _param = self._get_all_items_equipment_list_serialize(
            language=language,
            game=game,
    ...
    @validate_call
    def get_all_items_equipment_list_with_http_info(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
        sort_level: Annotated[Optional[StrictStr], Field(description="sort the resulting list by level, default unsorted")] = None,
    ...
    @validate_call
    def get_all_items_equipment_list_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
        sort_level: Annotated[Optional[StrictStr], Field(description="sort the resulting list by level, default unsorted")] = None,
    ...
    def _get_all_items_equipment_list_serialize(
        self,
        language,
        game,
        sort_level,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/equipment/all',
    ...
    def get_items_equipment_list(
        ...
        _param = self._get_items_equipment_list_serialize(
            language=language,
            game=game,
            sort_level=sort_level,
            filter_min_level=filter_min_level,
    ...
    @validate_call
    def get_items_equipment_list_with_http_info(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
        sort_level: Annotated[Optional[StrictStr], Field(description="sort the resulting list by level, default unsorted")] = None,
    ...
    @validate_call
    def get_items_equipment_list_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
        sort_level: Annotated[Optional[StrictStr], Field(description="sort the resulting list by level, default unsorted")] = None,
    ...
    def _get_items_equipment_list_serialize(
        self,
        language,
        game,
        sort_level,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/equipment',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_items_equipment_search(
        ...
        _param = self._get_items_equipment_search_serialize(
            language=language,
            game=game,
            query=query,
            filter_min_level=filter_min_level,
    ...
    @validate_call
    def get_items_equipment_search_with_http_info(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
        query: Annotated[StrictStr, Field(description="case sensitive search query")],
    ...
    @validate_call
    def get_items_equipment_search_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
        query: Annotated[StrictStr, Field(description="case sensitive search query")],
    ...
    def _get_items_equipment_search_serialize(
        self,
        language,
        game,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/equipment/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_items_equipment_single(
        ...
        _param = self._get_items_equipment_single_serialize(
            language=language,
            ankama_id=ankama_id,
            game=game,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_items_equipment_single_with_http_info(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        ankama_id: Annotated[StrictInt, Field(description="identifier")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
    ...
    @validate_call
    def get_items_equipment_single_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        ankama_id: Annotated[StrictInt, Field(description="identifier")],
        game: Annotated[StrictStr, Field(description="game main 'dofus3' or beta channel 'dofus3beta'")],
    ...
    def _get_items_equipment_single_serialize(
        self,
        language,
        ankama_id,
        game,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/items/equipment/{ankama_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
