...
class CosmeticsApi:
    ...
    def get_all_cosmetics_list(
        ...
        _param = self._get_all_cosmetics_list_serialize(
            language=language,
            game=game,
    ...
    @validate_call
    def get_all_cosmetics_list_with_http_info(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: StrictStr,
        sort_level: Annotated[Optional[StrictStr], Field(description="sort the resulting list by level, default unsorted")] = None,
    ...
    @validate_call
    def get_all_cosmetics_list_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: StrictStr,
        sort_level: Annotated[Optional[StrictStr], Field(description="sort the resulting list by level, default unsorted")] = None,
    ...
    def _get_all_cosmetics_list_serialize(
        self,
        language,
        game,
        sort_level,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/items/cosmetics/all',
    ...
    def get_cosmetics_list(
        ...
        _param = self._get_cosmetics_list_serialize(
            language=language,
            game=game,
            sort_level=sort_level,
            filter_type_name=filter_type_name,
    ...
    def _get_cosmetics_list_serialize(
        self,
        language,
        game,
        sort_level,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/items/cosmetics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_cosmetics_search(
        ...
        _param = self._get_cosmetics_search_serialize(
            language=language,
            game=game,
            query=query,
            filter_type_name=filter_type_name,
    ...
    @validate_call
    def get_cosmetics_search_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        game: StrictStr,
        query: Annotated[StrictStr, Field(description="case sensitive search query")],
    ...
    def _get_cosmetics_search_serialize(
        self,
        language,
        game,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/items/cosmetics/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_cosmetics_single(
        ...
        _param = self._get_cosmetics_single_serialize(
            language=language,
            ankama_id=ankama_id,
            game=game,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_cosmetics_single_with_http_info(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        ankama_id: Annotated[StrictInt, Field(description="identifier")],
        game: StrictStr,
    ...
    @validate_call
    def get_cosmetics_single_without_preload_content(
        self,
        language: Annotated[str, Field(min_length=2, strict=True, max_length=2, description="a valid language code")],
        ankama_id: Annotated[StrictInt, Field(description="identifier")],
        game: StrictStr,
    ...
    def _get_cosmetics_single_serialize(
        self,
        language,
        ankama_id,
        game,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/{language}/items/cosmetics/{ankama_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
