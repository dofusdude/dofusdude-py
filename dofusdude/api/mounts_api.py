...
class MountsApi:
    ...
    def get_all_mounts_list(
        ...
        :param filter_family_id: only results with the unique family id
        :type filter_family_id: int
    ...
    def _get_all_mounts_list_serialize(
        ...
        if filter_family_name is not None:
            ...
            _query_params.append(('filter[family.name]', filter_family_name))
            
        if filter_family_id is not None:
            
            _query_params.append(('filter[family.id]', filter_family_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/mounts/all',
    ...
    def _get_mounts_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/mounts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_mounts_search_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/mounts/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_mounts_single_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{game}/v1/{language}/mounts/{ankama_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
