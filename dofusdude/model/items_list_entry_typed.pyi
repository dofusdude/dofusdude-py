...
class ItemsListEntryTyped(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ankama_id", "name", "type", "item_subtype", "level", "image_urls", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ankama_id", "name", "type", "item_subtype", "level", "image_urls", ], str]):
        return super().get_item_oapg(name)
