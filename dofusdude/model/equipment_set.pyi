...
class EquipmentSet(
            ...
            class effects(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, i: int) -> 'EffectsEntry':
                            return super().__getitem__(i)
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["equipment_ids"]) -> MetaOapg.properties.equipment_ids: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ankama_id", "name", "equipment_ids", "effects", "level", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["equipment_ids"]) -> typing.Union[MetaOapg.properties.equipment_ids, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ankama_id", "name", "equipment_ids", "effects", "level", ], str]):
