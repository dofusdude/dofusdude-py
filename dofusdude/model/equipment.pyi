...
class Equipment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ankama_id", "name", "description", "type", "is_weapon", "level", "pods", "image_urls", "effects", "conditions", "recipe", "parent_set", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ankama_id", "name", "description", "type", "is_weapon", "level", "pods", "image_urls", "effects", "conditions", "recipe", "parent_set", ], str]):
        return super().get_item_oapg(name)
