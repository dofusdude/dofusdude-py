...
class PutTwitterWebhook(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["whitelist", "blacklist", "subscriptions", "preview_length", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["whitelist", "blacklist", "subscriptions", "preview_length", ], str]):
