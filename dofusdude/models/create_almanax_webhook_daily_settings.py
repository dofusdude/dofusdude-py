...
class CreateAlmanaxWebhookDailySettings(BaseModel):
    ...
    """
    timezone: Optional[StrictStr] = Field('Europe/Paris', description="Timezone of your community to determine midnight.")
    midnight_offset: Optional[conint(strict=True, le=23, ge=0)] = Field(0, description="Hours added to midnight at the selected timezone. 8 = 8:00 in the morning.")
    __properties = ["timezone", "midnight_offset"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAlmanaxWebhookDailySettings:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.midnight_offset is None and "midnight_offset" in self.__fields_set__:
            _dict['midnight_offset'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> CreateAlmanaxWebhookDailySettings:
        """Create an instance of CreateAlmanaxWebhookDailySettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAlmanaxWebhookDailySettings.parse_obj(obj)

        _obj = CreateAlmanaxWebhookDailySettings.parse_obj({
