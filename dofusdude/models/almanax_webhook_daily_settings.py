...
class AlmanaxWebhookDailySettings(BaseModel):
    ...
    midnight_offset: Optional[StrictInt] = Field(0, description="Hours added to midnight at the selected timezone. 8 = 8:00 in the morning.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlmanaxWebhookDailySettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlmanaxWebhookDailySettings:
        """Create an instance of AlmanaxWebhookDailySettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlmanaxWebhookDailySettings.parse_obj(obj)

        _obj = AlmanaxWebhookDailySettings.parse_obj({
