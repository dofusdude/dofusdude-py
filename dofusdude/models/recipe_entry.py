...
class RecipeEntry(BaseModel):
    ...
    RecipeEntry
    """
    item_ankama_id: Optional[StrictInt] = None
    item_subtype: Optional[StrictStr] = None
    quantity: Optional[StrictInt] = None
    __properties = ["item_ankama_id", "item_subtype", "quantity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecipeEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecipeEntry:
        """Create an instance of RecipeEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecipeEntry.parse_obj(obj)

        _obj = RecipeEntry.parse_obj({
            "item_ankama_id": obj.get("item_ankama_id"),
