...
class AlmanaxEntry(BaseModel):
    ...
    __properties = ["bonus", "date", "tribute"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlmanaxEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlmanaxEntry:
        """Create an instance of AlmanaxEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlmanaxEntry.parse_obj(obj)

        _obj = AlmanaxEntry.parse_obj({
            "bonus": AlmanaxEntryBonus.from_dict(obj.get("bonus")) if obj.get("bonus") is not None else None,
            "var_date": obj.get("date"),
            "tribute": AlmanaxEntryTribute.from_dict(obj.get("tribute")) if obj.get("tribute") is not None else None
        })
        return _obj
