...
class ConditionEntryElement(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConditionEntryElement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConditionEntryElement:
        """Create an instance of ConditionEntryElement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConditionEntryElement.parse_obj(obj)

        _obj = ConditionEntryElement.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("id"),
