...
class AlmanaxEntryBonus(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlmanaxEntryBonus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlmanaxEntryBonus:
        """Create an instance of AlmanaxEntryBonus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlmanaxEntryBonus.parse_obj(obj)

        _obj = AlmanaxEntryBonus.parse_obj({
            "description": obj.get("description"),
            "type": GetMetaAlmanaxBonuses200ResponseInner.from_dict(obj.get("type")) if obj.get("type") is not None else None
        })
        return _obj
