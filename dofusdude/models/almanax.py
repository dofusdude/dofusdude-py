...
class Almanax(BaseModel):
    ...
    reward_xp: Optional[StrictInt] = Field(default=None, description="Optional field that shows when a level is given in the request. Shows the experience points you get this day for finishing this Almanax quest.")
    __properties: ClassVar[List[str]] = ["bonus", "date", "tribute", "reward_kamas", "reward_xp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reward_xp (nullable) is None
        # and model_fields_set contains the field
        if self.reward_xp is None and "reward_xp" in self.model_fields_set:
            _dict['reward_xp'] = None
