...
class EffectsEntryType(BaseModel):
    """
    EffectsEntryType
    """
    name: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    is_meta: Optional[StrictBool] = Field(None, description="true if a type is generated from the Api instead of Ankama. In that case, always prefer showing the templated string and omit everything else. The \"name\" field will have an english description of the meta type. An example for such effects are class sets effects.")
    is_active: Optional[StrictBool] = Field(None, description="Affects target or source actively.")
    __properties = ["name", "id", "is_meta", "is_active"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EffectsEntryType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EffectsEntryType:
        """Create an instance of EffectsEntryType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EffectsEntryType.parse_obj(obj)

        _obj = EffectsEntryType.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("id"),
