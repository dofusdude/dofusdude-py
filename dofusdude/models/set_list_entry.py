...
class SetListEntry(BaseModel):
    ...
    items: Optional[StrictInt] = Field(None, description="amount")
    level: Optional[StrictInt] = None
    __properties = ["ankama_id", "name", "items", "level"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetListEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetListEntry:
        """Create an instance of SetListEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetListEntry.parse_obj(obj)

        _obj = SetListEntry.parse_obj({
