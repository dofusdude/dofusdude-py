...
class AlmanaxEntryTributeItem(BaseModel):
    """
    ...
    __properties = ["ankama_id", "image_urls", "name", "subtype"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlmanaxEntryTributeItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlmanaxEntryTributeItem:
        """Create an instance of AlmanaxEntryTributeItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlmanaxEntryTributeItem.parse_obj(obj)

        _obj = AlmanaxEntryTributeItem.parse_obj({
