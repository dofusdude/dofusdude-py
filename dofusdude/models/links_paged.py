...
class LinksPaged(BaseModel):
    ...
    __properties = ["first", "prev", "next", "last"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinksPaged:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinksPaged:
        """Create an instance of LinksPaged from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinksPaged.parse_obj(obj)

        _obj = LinksPaged.parse_obj({
            "first": obj.get("first"),
            "prev": obj.get("prev"),
            "next": obj.get("next"),
            "last": obj.get("last")
