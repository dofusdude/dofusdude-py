...
class EquipmentParentSet(BaseModel):
    """
    EquipmentParentSet
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EquipmentParentSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EquipmentParentSet:
        """Create an instance of EquipmentParentSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EquipmentParentSet.parse_obj(obj)

        _obj = EquipmentParentSet.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
