...
class PutTwitterWebhook(BaseModel):
    ...
    subscriptions: Optional[conlist(StrictStr, unique_items=True)] = Field(None, description="Get the available subscriptions with /meta/webhooks/twitter")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PutTwitterWebhook:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PutTwitterWebhook:
        """Create an instance of PutTwitterWebhook from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PutTwitterWebhook.parse_obj(obj)

        _obj = PutTwitterWebhook.parse_obj({
