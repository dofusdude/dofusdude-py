...
from pydantic import BaseModel, StrictStr, conint, conlist, validator
...
class RssWebhook(BaseModel):
    ...
    subscriptions: Optional[conlist(StrictStr)] = None
    format: Optional[StrictStr] = None
    preview_length: Optional[conint(strict=True, le=4000, ge=0)] = None
    created_at: Optional[datetime] = None
    last_fired_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties = ["id", "whitelist", "blacklist", "subscriptions", "format", "preview_length", "created_at", "last_fired_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RssWebhook:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RssWebhook:
        """Create an instance of RssWebhook from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RssWebhook.parse_obj(obj)

        _obj = RssWebhook.parse_obj({
            "id": obj.get("id"),
