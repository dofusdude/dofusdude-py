...
class Equipment(BaseModel):
    ...
    __properties = ["ankama_id", "name", "description", "type", "is_weapon", "level", "pods", "image_urls", "effects", "conditions", "recipe", "parent_set"]
    ...
    def from_dict(cls, obj: dict) -> Equipment:
        ...
        if not isinstance(obj, dict):
            return Equipment.parse_obj(obj)

        _obj = Equipment.parse_obj({
