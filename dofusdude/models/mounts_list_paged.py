...
class MountsListPaged(BaseModel):
    ...
    items: Optional[conlist(MountListEntry)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MountsListPaged:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MountsListPaged:
        """Create an instance of MountsListPaged from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MountsListPaged.parse_obj(obj)

        _obj = MountsListPaged.parse_obj({
            "links": LinksPaged.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "items": [MountListEntry.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
