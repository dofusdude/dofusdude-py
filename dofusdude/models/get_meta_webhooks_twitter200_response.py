...
class GetMetaWebhooksTwitter200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMetaWebhooksTwitter200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMetaWebhooksTwitter200Response:
        """Create an instance of GetMetaWebhooksTwitter200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetMetaWebhooksTwitter200Response.parse_obj(obj)

        _obj = GetMetaWebhooksTwitter200Response.parse_obj({
