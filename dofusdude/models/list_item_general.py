...
class ListItemGeneral(BaseModel):
    """
    ListItemGeneral
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.item_subtype:
            _dict['item_subtype'] = self.item_subtype.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item_subtype": ItemSubtype.from_dict(obj["item_subtype"]) if obj.get("item_subtype") is not None else None,
            "level": obj.get("level"),
