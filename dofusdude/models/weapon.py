...
class Weapon(BaseModel):
    ...
    is_weapon: Optional[StrictBool] = Field(None, description="always true when the item is a weapon. Many fields are now available. Always check for this flag first when getting single equipment items.")
    ...
    __properties = ["ankama_id", "name", "description", "type", "is_weapon", "level", "pods", "image_urls", "effects", "conditions", "critical_hit_probability", "critical_hit_bonus", "is_two_handed", "max_cast_per_turn", "ap_cost", "range", "recipe", "parent_set"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.parent_set is None and "parent_set" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> Weapon:
        ...
        _obj = Weapon.parse_obj({
            ...
            "range": WeaponRange.from_dict(obj.get("range")) if obj.get("range") is not None else None,
            "recipe": [RecipeEntry.from_dict(_item) for _item in obj.get("recipe")] if obj.get("recipe") is not None else None,
            "parent_set": EquipmentParentSet.from_dict(obj.get("parent_set")) if obj.get("parent_set") is not None else None
        })
        return _obj
