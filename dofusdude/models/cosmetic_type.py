...
class CosmeticType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CosmeticType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CosmeticType:
        """Create an instance of CosmeticType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CosmeticType.parse_obj(obj)

        _obj = CosmeticType.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("id")
        })
        return _obj
