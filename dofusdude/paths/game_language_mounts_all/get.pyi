...
SchemaFor200ResponseBodyApplicationJson = MountsListPaged
...
class GetAllMountsList(BaseApi):
    ...
    def get_all_mounts_list(
        ...
        return self._get_all_mounts_list_oapg(
