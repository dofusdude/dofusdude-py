...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['SetListEntry'], typing.List['SetListEntry']],
...
class GetSetsSearch(BaseApi):
    ...
    def get_sets_search(
        ...
        return self._get_sets_search_oapg(
