...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ItemsListEntryTyped']:
            return ItemsListEntryTyped

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ItemsListEntryTyped'], typing.List['ItemsListEntryTyped']],
    ...
    def __getitem__(self, i: int) -> 'ItemsListEntryTyped':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_items_all_search_oapg(
        self,
...
class GetItemsAllSearch(BaseApi):
    ...
    def get_items_all_search(
        ...
        return self._get_items_all_search_oapg(
