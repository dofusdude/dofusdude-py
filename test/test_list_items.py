...
class TestListItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListItems:
        """Test ListItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListItems`
        """
        model = ListItems()
        if include_optional:
            return ListItems(
                links = dofusdude.models.paged_links.PagedLinks(
                    ...
                    last = '', ),
                items = [
                    dofusdude.models.list_item.ListItem(
                        ankama_id = 56, 
                        name = '', 
                        ...
                        ap_cost = 56, 
                        range = dofusdude.models.range.Range(
                            min = 56, 
                            max = 56, ), )
                    ]
            )
