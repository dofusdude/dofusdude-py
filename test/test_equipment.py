...
import dofusdude
from dofusdude.models.equipment import Equipment  # noqa: E501
...
class TestEquipment(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = dofusdude.models.equipment.Equipment()  # noqa: E501
        if include_optional :
            return Equipment(
                ankama_id = 56, 
                name = '', 
                ...
                parent_set = dofusdude.models.equipment_parent_set.Equipment_parent_set(
                    id = 56, 
                    name = '', )
            )
        else :
