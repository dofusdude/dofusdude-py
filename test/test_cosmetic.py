...
import dofusdude
from dofusdude.models.cosmetic import Cosmetic  # noqa: E501
...
class TestCosmetic(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `Cosmetic`
        """
        model = dofusdude.models.cosmetic.Cosmetic()  # noqa: E501
        if include_optional :
            return Cosmetic(
                ankama_id = 56, 
                name = '', 
