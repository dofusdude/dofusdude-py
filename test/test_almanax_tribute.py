...
class TestAlmanaxTribute(unittest.TestCase):
    """AlmanaxTribute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlmanaxTribute:
        """Test AlmanaxTribute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlmanaxTribute`
        """
        model = AlmanaxTribute()
        if include_optional:
            return AlmanaxTribute(
