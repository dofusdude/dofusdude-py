...
class TestMetaApi(unittest.TestCase):
    ...
    def test_get_game_search_types(self) -> None:
        """Test case for get_game_search_types
    ...
    def test_get_meta_almanax_bonuses(self) -> None:
    ...
    def test_get_meta_almanax_bonuses_search(self) -> None:
        """Test case for get_meta_almanax_bonuses_search

        Search Available Almanax Bonuses
        """
        pass

    def test_get_meta_elements(self) -> None:
    ...
    def test_get_meta_version(self) -> None:
        """Test case for get_meta_version
