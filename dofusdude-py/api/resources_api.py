...
class ResourcesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_items_resource_search_endpoint = _Endpoint(
            settings={
                'response_type': ([ItemListEntry],),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/resources/search',
                'operation_id': 'get_items_resource_search',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_items_resources_list_endpoint = _Endpoint(
            settings={
                'response_type': (ItemsListPaged,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/resources',
                'operation_id': 'get_items_resources_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_items_resources_single_endpoint = _Endpoint(
            settings={
                'response_type': (Resource,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/resources/{ankama_id}',
                'operation_id': 'get_items_resources_single',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_items_resource_search(
        ...
        **kwargs
        ...
        >>> thread = api.get_items_resource_search(language, game, query, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['query'] = \
            query
        return self.get_items_resource_search_endpoint.call_with_http_info(**kwargs)
    ...
    def get_items_resources_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_items_resources_list(language, game, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['game'] = \
            game
        return self.get_items_resources_list_endpoint.call_with_http_info(**kwargs)

    def get_items_resources_single(
        self,
        language,
        ankama_id,
        game,
        **kwargs
        ...
        kwargs['game'] = \
            game
        return self.get_items_resources_single_endpoint.call_with_http_info(**kwargs)
