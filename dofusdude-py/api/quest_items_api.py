...
class QuestItemsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_item_quest_single_endpoint = _Endpoint(
            settings={
                'response_type': (Resource,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/quest/{ankama_id}',
                'operation_id': 'get_item_quest_single',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_items_quest_list_endpoint = _Endpoint(
            settings={
                'response_type': (ItemsListPaged,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/quest',
                'operation_id': 'get_items_quest_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_items_quest_search_endpoint = _Endpoint(
            settings={
                'response_type': ([ItemListEntry],),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/quest/search',
                'operation_id': 'get_items_quest_search',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_item_quest_single(
        ...
        **kwargs
        ...
        kwargs['game'] = \
            game
        return self.get_item_quest_single_endpoint.call_with_http_info(**kwargs)
    ...
    def get_items_quest_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_items_quest_list(language, game, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['game'] = \
            game
        return self.get_items_quest_list_endpoint.call_with_http_info(**kwargs)
    ...
    def get_items_quest_search(
        ...
        **kwargs
        ...
        >>> thread = api.get_items_quest_search(language, game, query, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['query'] = \
            query
        return self.get_items_quest_search_endpoint.call_with_http_info(**kwargs)
