...
class MetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_meta_almanax_bonuses_endpoint = _Endpoint(
            settings={
                'response_type': ([GetMetaAlmanaxBonuses200ResponseInner],),
                'auth': [],
                'endpoint_path': '/dofus2/meta/{language}/almanax/bonuses',
                'operation_id': 'get_meta_almanax_bonuses',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_meta_elements_endpoint = _Endpoint(
            settings={
                'response_type': ([str],),
                'auth': [],
                'endpoint_path': '/dofus2/meta/elements',
                'operation_id': 'get_meta_elements',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_meta_almanax_bonuses(
        ...
        **kwargs
        ...
        kwargs['language'] = \
            language
        return self.get_meta_almanax_bonuses_endpoint.call_with_http_info(**kwargs)
    ...
    def get_meta_elements(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_meta_elements_endpoint.call_with_http_info(**kwargs)
