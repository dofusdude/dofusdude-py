...
class EquipmentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_items_equipment_list_endpoint = _Endpoint(
            settings={
                'response_type': (ItemsListPaged,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/equipment',
                'operation_id': 'get_items_equipment_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_items_equipment_search_endpoint = _Endpoint(
            settings={
                'response_type': ([ItemListEntry],),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/equipment/search',
                'operation_id': 'get_items_equipment_search',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_items_equipment_single_endpoint = _Endpoint(
            settings={
                'response_type': (Weapon,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/equipment/{ankama_id}',
                'operation_id': 'get_items_equipment_single',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_items_equipment_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_items_equipment_list(language, game, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['game'] = \
            game
        return self.get_items_equipment_list_endpoint.call_with_http_info(**kwargs)
    ...
    def get_items_equipment_search(
        ...
        **kwargs
        ...
        >>> thread = api.get_items_equipment_search(language, game, query, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['query'] = \
            query
        return self.get_items_equipment_search_endpoint.call_with_http_info(**kwargs)

    def get_items_equipment_single(
        self,
        language,
        ankama_id,
        game,
        **kwargs
        ...
        kwargs['game'] = \
            game
        return self.get_items_equipment_single_endpoint.call_with_http_info(**kwargs)
