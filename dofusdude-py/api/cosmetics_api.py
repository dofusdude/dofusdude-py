...
class CosmeticsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_cosmetics_list_endpoint = _Endpoint(
            settings={
                'response_type': (ItemsListPaged,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/cosmetics',
                'operation_id': 'get_cosmetics_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_cosmetics_search_endpoint = _Endpoint(
            settings={
                'response_type': ([ItemListEntry],),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/cosmetics/search',
                'operation_id': 'get_cosmetics_search',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_cosmetics_single_endpoint = _Endpoint(
            settings={
                'response_type': (Cosmetic,),
                'auth': [],
                'endpoint_path': '/{game}/{language}/items/cosmetics/{ankama_id}',
                'operation_id': 'get_cosmetics_single',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_cosmetics_list(
        ...
        **kwargs
        ...
        >>> thread = api.get_cosmetics_list(language, game, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['game'] = \
            game
        return self.get_cosmetics_list_endpoint.call_with_http_info(**kwargs)

    def get_cosmetics_search(
        self,
        language,
        game,
        query,
        **kwargs
        ...
        >>> thread = api.get_cosmetics_search(language, game, query, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['query'] = \
            query
        return self.get_cosmetics_search_endpoint.call_with_http_info(**kwargs)

    def get_cosmetics_single(
        self,
        language,
        ankama_id,
        game,
        **kwargs
        ...
        kwargs['game'] = \
            game
        return self.get_cosmetics_single_endpoint.call_with_http_info(**kwargs)
