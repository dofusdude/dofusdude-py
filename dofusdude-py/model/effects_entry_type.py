...
class EffectsEntryType(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EffectsEntryType - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_meta (bool): true if a type is generated from the Api instead of Ankama. In that case, always prefer showing the templated string and omit everything else. The \"name\" field will have an english description of the meta type. An example for such effects are class sets effects.. [optional]  # noqa: E501
        """
