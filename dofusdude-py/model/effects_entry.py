...
class EffectsEntry(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'int_minimum': (int,),  # noqa: E501
            'int_maximum': (int,),  # noqa: E501
            'type': (EffectsEntryType,),  # noqa: E501
            'ignore_int_min': (bool,),  # noqa: E501
            'ignore_int_max': (bool,),  # noqa: E501
    ...
    attribute_map = {
        'int_minimum': 'int_minimum',  # noqa: E501
        'int_maximum': 'int_maximum',  # noqa: E501
        'type': 'type',  # noqa: E501
        'ignore_int_min': 'ignore_int_min',  # noqa: E501
        'ignore_int_max': 'ignore_int_max',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EffectsEntry - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            int_minimum (int): minimum int value, can be a single if ignore_int_max and no ignore_int_min. [optional]  # noqa: E501
            int_maximum (int): maximum int value, if not ignore_int_max and not ignore_int_min, the effect has a range value. [optional]  # noqa: E501
            type (EffectsEntryType): [optional]  # noqa: E501
            ignore_int_min (bool): ignore the int min field because the actual value is a string. For readability the templated field is the only important field in this case. . [optional]  # noqa: E501
            ignore_int_max (bool): ignore the int max field, if ignore_int_min is true, int min is a single value. [optional]  # noqa: E501
            formatted (str): all fields from above encoded in a single string. [optional]  # noqa: E501
        """
