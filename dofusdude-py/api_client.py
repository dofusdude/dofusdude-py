...
from dofusdude-py import rest
from dofusdude-py.configuration import Configuration
from dofusdude-py.exceptions import ApiTypeError, ApiValueError, ApiException
from dofusdude-py.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AllItemsApi()
        api_instance.get_items_all_search  # this is an instance of the class Endpoint
        api_instance.get_items_all_search()  # this invokes api_instance.get_items_all_search.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_items_all_search.callable or self.callable in this class
