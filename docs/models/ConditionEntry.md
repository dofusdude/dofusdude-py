# dofusdude.model.condition_entry.ConditionEntry
...
------------ | ------------- | ------------- | ------------- | -------------
**operator** | str,  | str,  |  | [optional] 
**int_value** | decimal.Decimal, int,  | decimal.Decimal,  |  | [optional] 
**[element](#element)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
