# dofusdude.model.put_twitter_webhook.PutTwitterWebhook
...
**[subscriptions](#subscriptions)** | list, tuple, None,  | tuple, NoneClass,  | Get the available subscriptions with /meta/webhooks/twitter | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple, None,  | tuple, NoneClass,  | Get the available subscriptions with /meta/webhooks/twitter | 
