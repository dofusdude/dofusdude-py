# dofusdude.model.almanax_webhook.AlmanaxWebhook
...
**[daily_settings](#daily_settings)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
**[bonus_whitelist](#bonus_whitelist)** | list, tuple, None,  | tuple, NoneClass,  | Only post when these bonuses come up. From all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses. | [optional] 
**[bonus_blacklist](#bonus_blacklist)** | list, tuple, None,  | tuple, NoneClass,  | Skip the day when these bonuses come up. From all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses | [optional] 
**[subscriptions](#subscriptions)** | list, tuple,  | tuple,  | Get the available subscriptions with /meta/webhooks/almanax | [optional] 
**iso_date** | bool,  | BoolClass,  | If false, it will use common local time formats and weekday translations. If true, the format is YYYY-MM-DD. | [optional] if omitted the server will use the default value of False
