...
# **get_sets_list**
> SetsListPaged get_sets_list(language, game)
...
with dofusdude.ApiClient() as api_client:
    ...
    filter_min_highest_equipment_level = 0 # int | only results where the equipment with the highest level is above or equal to this value (optional)
    filter_max_highest_equipment_level = 0 # int | only results where the equipment with the highest level is below or equal to this value (optional)
...
# **get_sets_search**
> [SetListEntry] get_sets_search(language, game, query)
...
with dofusdude.ApiClient() as api_client:
    ...
    filter_min_highest_equipment_level = 1 # int | only results where the equipment with the highest level is above or equal to this value (optional)
    filter_max_highest_equipment_level = 1 # int | only results where the equipment with the highest level is below or equal to this value (optional)
