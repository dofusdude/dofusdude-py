...
> ItemsListPaged get_all_cosmetics_list(language, game, sort_level=sort_level, filter_type_name=filter_type_name, filter_min_level=filter_min_level, filter_max_level=filter_max_level, accept_encoding=accept_encoding)
...
with dofusdude.ApiClient(configuration) as api_client:
    ...
    try:
        # List All Cosmetics
        api_response = api_instance.get_all_cosmetics_list(language, game, sort_level=sort_level, filter_type_name=filter_type_name, filter_min_level=filter_min_level, filter_max_level=filter_max_level, accept_encoding=accept_encoding)
