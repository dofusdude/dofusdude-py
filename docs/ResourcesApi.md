...
> List[ItemListEntry] get_items_resource_search(language, game, query, filter_type_name=filter_type_name, filter_min_level=filter_min_level, filter_max_level=filter_max_level, limit=limit)
...
with dofusdude.ApiClient(configuration) as api_client:
    ...
    try:
        # Search Resources
        api_response = api_instance.get_items_resource_search(language, game, query, filter_type_name=filter_type_name, filter_min_level=filter_min_level, filter_max_level=filter_max_level, limit=limit)
...
> ItemsListPaged get_items_resources_list(language, game, sort_level=sort_level, filter_type_name=filter_type_name, filter_min_level=filter_min_level, filter_max_level=filter_max_level, page_size=page_size, page_number=page_number, fields_item=fields_item)
