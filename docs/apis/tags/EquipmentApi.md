<a name="__pageTop"></a>
# dofusdude.apis.tags.equipment_api.EquipmentApi
...
> ItemsListPaged get_items_equipment_list(languagegame)
...
with dofusdude.ApiClient(configuration) as api_client:
    ...
    try:
        # List Equipment
        api_response = api_instance.get_items_equipment_list(
            path_params=path_params,
            query_params=query_params,
        )
        pprint(api_response)
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_items_equipment_list.ApiResponseFor200) | Equipment Found
400 | [ApiResponseFor400](#get_items_equipment_list.ApiResponseFor400) | Bad Request 
404 | [ApiResponseFor404](#get_items_equipment_list.ApiResponseFor404) | Not Found

#### get_items_equipment_list.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
#### get_items_equipment_list.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### get_items_equipment_list.ApiResponseFor404
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
<a name="get_items_equipment_search"></a>
> [ItemListEntry] get_items_equipment_search(languagegamequery)
...
with dofusdude.ApiClient(configuration) as api_client:
    ...
    try:
        # Search Equipment
        api_response = api_instance.get_items_equipment_search(
            path_params=path_params,
            query_params=query_params,
        )
        pprint(api_response)
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_items_equipment_search.ApiResponseFor200) | Equipment Found
400 | [ApiResponseFor400](#get_items_equipment_search.ApiResponseFor400) | Bad Request  Possibilities: - empty or no query 
404 | [ApiResponseFor404](#get_items_equipment_search.ApiResponseFor404) | Not Found  Possibilities: - no hits for query

#### get_items_equipment_search.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
#### get_items_equipment_search.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### get_items_equipment_search.ApiResponseFor404
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
<a name="get_items_equipment_single"></a>
> Weapon get_items_equipment_single(languageankama_idgame)
...
with dofusdude.ApiClient(configuration) as api_client:
    ...
    try:
        # Single Equipment
        api_response = api_instance.get_items_equipment_single(
            path_params=path_params,
        )
        pprint(api_response)
    except dofusdude.ApiException as e:
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_items_equipment_single.ApiResponseFor200) | Equipment Found
400 | [ApiResponseFor400](#get_items_equipment_single.ApiResponseFor400) | Bad Request  Possibilities: - invalid ankama id format 
404 | [ApiResponseFor404](#get_items_equipment_single.ApiResponseFor404) | Not Found  Possibilities: - nothing found for this ankama_id

#### get_items_equipment_single.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
Type | Description  | Notes
------------- | ------------- | -------------
[**Weapon**](../../models/Weapon.md) |  | 


#### get_items_equipment_single.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### get_items_equipment_single.ApiResponseFor404
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
